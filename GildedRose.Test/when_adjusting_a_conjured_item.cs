...
public class when_adjusting_a_conjured_item
{
    ...
    [DataRow(10, 10, 8)]
    [DataRow(0, 0, 0)]
    public void it_should_degrade_quality_at_double_rate(int preAdjustmentSellIn, int originalQuality, int newQualityAfterDoubleDegradation)
    {
        ...
        Assert.AreEqual(newQualityAfterDoubleDegradation, conjuredInventoryItem.Quality);
    }
}